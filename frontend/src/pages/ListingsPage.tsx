...
const ListingsPage: React.FC = () => {
  ...
  const [bookedListingTitle, setBookedListingTitle] = useState<string | null>(
    null
  );
  ...
  // 建一个 sellerId -> User 的 map，查起来 O(1)
  ...
  const loadListings = async () => {
    try {
      setLoading(true);
      setError(null);
      const data: Listing[] = await apiGet("/api/listings?status=available");
      setListings(data);
    } catch (err: any) {
  ...
  const handleBook = async (
    ...
    try {
      await apiPatch(`/api/listings/${listingId}/book`, {
      ...
      setBookedListingTitle(listingTitle);
      setShowBookSuccessModal(true);
    } catch (err: any) {
      alert(err.message || "Failed to book listing");
    }
  };

  const closeBookSuccessModal = () => {
    setShowBookSuccessModal(false);
    setBookedListingTitle(null);
  };
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Book items from other users. You can’t book your own listings.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="card-body flex-1 flex flex-col gap-1 p-3">
                ...
                <button
                  type="button"
                  className="text-xs text-gray-500 hover:text-gray-800 underline-offset-2 hover:underline px-0 py-0"
                ...
                <div className="card-actions justify-between items-center mt-auto">
                  {listing.sellerId === currentUserId ? (
                    ...
                    <button
                      onClick={() => handleBook(listing.id, listing.title)}
      ...
      {showBookSuccessModal && (
        <div className="modal">
          <div className="modal-backdrop" onClick={closeBookSuccessModal} />
          <div className="modal-box">
            ...
            <p className="modal-body-text">
              ...
              <span className="font-semibold">
                {bookedListingTitle ?? "this listing"}
              </span>
              .
            </p>
            ...
            <div className="modal-box max-w-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="modal-actions justify-end">
                  {selectedListing.sellerId === currentUserId ? (
                    <button
                      type="button"
                      className="btn"
                      onClick={() => setSelectedListing(null)}
